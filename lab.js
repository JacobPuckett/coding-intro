...
if (amysBirthYear === brittanisBirthYear){
  console.log('Amy & Brittani where born in the same year')
}else{
  console.log('Amy & Brittani where not born in the same year')
}
...
if (temperature >= 80 && rain){
  ...
  console.log('one should weawr a rain-jacket')
